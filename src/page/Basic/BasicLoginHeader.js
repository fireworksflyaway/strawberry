        ...
        render(){
                return (
                        ...
                        >
                                ...
                                <Menu.Item key="/basicupload"><Link to='/basicupload'>上传数据</Link></Menu.Item>
                                <Menu.Item key="/basicevent"><Link to='/basicevent'>查看任务进度</Link></Menu.Item>
                                <Menu.Item key="/basicreport"><Link to='/basicreport' >查看报告</Link></Menu.Item>
                                <Menu.SubMenu title={<strong><Icon type="user" />{this.props.username}</strong>}>
                                        <Menu.Item key="/basicprofile"><Link to='/basicprofile' ><Icon type="edit" />编辑个人信息</Link></Menu.Item>
